...
<body>
    <div class="reg">
        ...
        <!-- 文件上传的条件
             表单必须是POST的提交方式
             表单中必须有文件上传项，文件上传项必须有name的属性和值； JSP控制name JS控制id
             表单的enctype属性必须设置为multipart/form-data
             application/x-www-form-urlencoded 是适用 request 和 response
         -->
        <form action="/chapter2/login/RegistServlet" method="post" enctype="multipart/form-data">
            <table>
                <tr>
                    <td class="td1">用户名</td>

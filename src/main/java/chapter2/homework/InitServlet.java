...
import chapter2.homework.foodsUtils.Food;
...
@WebServlet(name = "InitServlet",urlPatterns = "/chapter2/homework/InitServlet",loadOnStartup = 1)
public class InitServlet extends HttpServlet {
    ...
    public void init() throws ServletException {
        ...
        //创建一个用户
        User user = new User(1,"usaimimizugi","3436260@qq.com","ourinsama");
        //添加到用户列表中
        userList.add(user);
        //获取服务器context
        ...
        foodList.add(koushuiji);
        foodList.add(shuizhuyu);
        foodList.add(mapotoufu);
        foodList.add(shuancaiyu);
        foodList.add(laizji);
        foodList.add(yuxiangrousi);
        //添加到菜品列表
